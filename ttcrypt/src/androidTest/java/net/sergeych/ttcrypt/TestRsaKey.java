...
//		assertFalse(key.equals(pubk));
    ...
    public void testFactorize() throws Exception {
        ...
        BigInteger p1 = new BigInteger(27, 200, rnd);
        BigInteger p2 = new BigInteger(31, 200, rnd);
        BigInteger composite = p1.multiply(p2);
        BigInteger[] factors = RsaKey.factorize(composite);
        assertEquals(composite, factors[0].multiply(factors[1]));
    }
